...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Hamac International | User Login</title>
            ...
            <div class="row bs-reset">
                <div class="col-md-6 bs-reset mt-login-5-bsfix">
                    <div class="login-bg" style="background-image:url(<?php echo base_url() ?>assets/pages/img/login/bg1.jpg)">
                        <img class="login-logo" src="<?php echo base_url() ?>assets/img/lawang.png" /> </div>
                </div>
                <div class="col-md-6 login-container bs-reset mt-login-5-bsfix">
                    <div class="login-content">
                        <h1>Hamac Admin Login</h1>
                        <p>Silahkan login menggunakan username dan password yang telah diberikan.</p>
                        <?php echo form_open('lawang', array('class' => 'login-form')); ?>
